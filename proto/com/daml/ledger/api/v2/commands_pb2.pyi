...
class Command(_message.Message):
    __slots__ = ["create", "create_and_exercise", "exercise", "exercise_by_key"]
...
class Commands(_message.Message):
    __slots__ = ["act_as", "command_id", "commands", "deduplication_duration", "deduplication_offset", "disclosed_contracts", "min_ledger_time_abs", "min_ledger_time_rel", "package_id_selection_preference", "prefetch_contract_keys", "read_as", "submission_id", "synchronizer_id", "user_id", "workflow_id"]
...
class CreateAndExerciseCommand(_message.Message):
    __slots__ = ["choice", "choice_argument", "create_arguments", "template_id"]
...
class CreateCommand(_message.Message):
    __slots__ = ["create_arguments", "template_id"]
    CREATE_ARGUMENTS_FIELD_NUMBER: _ClassVar[int]
    TEMPLATE_ID_FIELD_NUMBER: _ClassVar[int]
    create_arguments: _value_pb2.Record
    template_id: _value_pb2.Identifier
...
class DisclosedContract(_message.Message):
    __slots__ = ["contract_id", "created_event_blob", "synchronizer_id", "template_id"]
...
class ExerciseByKeyCommand(_message.Message):
    __slots__ = ["choice", "choice_argument", "contract_key", "template_id"]
    CHOICE_ARGUMENT_FIELD_NUMBER: _ClassVar[int]
    CHOICE_FIELD_NUMBER: _ClassVar[int]
...
class ExerciseCommand(_message.Message):
    __slots__ = ["choice", "choice_argument", "contract_id", "template_id"]
    CHOICE_ARGUMENT_FIELD_NUMBER: _ClassVar[int]
    CHOICE_FIELD_NUMBER: _ClassVar[int]
    CONTRACT_ID_FIELD_NUMBER: _ClassVar[int]
    TEMPLATE_ID_FIELD_NUMBER: _ClassVar[int]
...
class PrefetchContractKey(_message.Message):
    __slots__ = ["contract_key", "template_id"]
    CONTRACT_KEY_FIELD_NUMBER: _ClassVar[int]
    TEMPLATE_ID_FIELD_NUMBER: _ClassVar[int]
    contract_key: _value_pb2.Value
    template_id: _value_pb2.Identifier
