...
class CreatedEvent(_message.Message):
    __slots__ = ("offset", "node_id", "contract_id", "template_id", "contract_key", "create_arguments", "created_event_blob", "interface_views", "witness_parties", "signatories", "observers", "created_at", "package_name", "acs_delta")
