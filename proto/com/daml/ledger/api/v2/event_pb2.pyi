...
class CreatedEvent(_message.Message):
    __slots__ = ["contract_id", "contract_key", "create_arguments", "created_at", "created_event_blob", "interface_views", "node_id", "observers", "offset", "package_name", "signatories", "template_id", "witness_parties"]
    CONTRACT_ID_FIELD_NUMBER: _ClassVar[int]
...
class ExercisedEvent(_message.Message):
    __slots__ = ["acting_parties", "choice", "choice_argument", "consuming", "contract_id", "exercise_result", "implemented_interfaces", "interface_id", "last_descendant_node_id", "node_id", "offset", "package_name", "template_id", "witness_parties"]
