...
class Metadata(_message.Message):
    __slots__ = ("submitter_info", "synchronizer_id", "mediator_group", "transaction_uuid", "submission_time", "input_contracts", "min_ledger_effective_time", "max_ledger_effective_time", "global_key_mapping")
