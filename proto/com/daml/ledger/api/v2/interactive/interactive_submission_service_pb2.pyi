...
class ExecuteSubmissionAndWaitForTransactionRequest(_message.Message):
    __slots__ = ["deduplication_duration", "deduplication_offset", "hashing_scheme_version", "min_ledger_time", "party_signatures", "prepared_transaction", "submission_id", "transaction_format", "user_id"]
...
class ExecuteSubmissionAndWaitResponse(_message.Message):
    __slots__ = ["completion_offset", "update_id"]
...
class Metadata(_message.Message):
    __slots__ = ["global_key_mapping", "input_contracts", "max_ledger_effective_time", "mediator_group", "min_ledger_effective_time", "preparation_time", "submitter_info", "synchronizer_id", "transaction_uuid"]
    ...
    class InputContract(_message.Message):
        __slots__ = ["created_at", "event_blob", "v1"]
...
class PackageVettingRequirement(_message.Message):
    __slots__ = ["package_name", "parties"]
    PACKAGE_NAME_FIELD_NUMBER: _ClassVar[int]
    PARTIES_FIELD_NUMBER: _ClassVar[int]
    package_name: str
    parties: _containers.RepeatedScalarFieldContainer[str]
