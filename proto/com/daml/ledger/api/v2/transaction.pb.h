...
typedef struct _com_daml_ledger_api_v2_TransactionTree {
 ...
 Required */
    char update_id[1024];
    /* The ID of the command which resulted in this transaction. Missing for everyone except the
 submitting party. Must be a valid LedgerString (as described in ``value.proto``). Optional */
    char command_id[1024];
    /* The workflow ID used in command submission. Only set if the ``workflow_id`` for the command
 was set. Must be a valid LedgerString (as described in ``value.proto``). Optional */
    char workflow_id[1024];
 ...
 ``community/ledger-api/README.md``. Required, it is a valid absolute offset (positive integer). */
    int64_t offset;
...
#define com_daml_ledger_api_v2_TreeEvent_init_default        \
    {                                                        \
        0, {                                                 \
            com_daml_ledger_api_v2_CreatedEvent_init_default \
        }                                                    \
    }
#define com_daml_ledger_api_v2_TransactionTree_init_default                                      \
    {                                                                                            \
        "", "", "", false, google_protobuf_Timestamp_init_default, 0, {{NULL}, NULL}, "", false, \
            com_daml_ledger_api_v2_TraceContext_init_default, false,                             \
            google_protobuf_Timestamp_init_default                                               \
    }
#define com_daml_ledger_api_v2_TransactionTree_EventsByIdEntry_init_default \
    { 0, false, com_daml_ledger_api_v2_TreeEvent_init_default }
#define com_daml_ledger_api_v2_Transaction_init_default                                          \
    {                                                                                            \
        "", "", "", false, google_protobuf_Timestamp_init_default, {{NULL}, NULL}, 0, "", false, \
            com_daml_ledger_api_v2_TraceContext_init_default, false,                             \
            google_protobuf_Timestamp_init_default, false, {                                     \
            0, {                                                                                 \
                0                                                                                \
            }                                                                                    \
        }                                                                                        \
    }
#define com_daml_ledger_api_v2_TreeEvent_init_zero        \
    {                                                     \
        0, {                                              \
            com_daml_ledger_api_v2_CreatedEvent_init_zero \
        }                                                 \
    }
#define com_daml_ledger_api_v2_TransactionTree_init_zero                                      \
    {                                                                                         \
        "", "", "", false, google_protobuf_Timestamp_init_zero, 0, {{NULL}, NULL}, "", false, \
            com_daml_ledger_api_v2_TraceContext_init_zero, false,                             \
            google_protobuf_Timestamp_init_zero                                               \
    }
#define com_daml_ledger_api_v2_TransactionTree_EventsByIdEntry_init_zero \
    { 0, false, com_daml_ledger_api_v2_TreeEvent_init_zero }
#define com_daml_ledger_api_v2_Transaction_init_zero                                          \
    {                                                                                         \
        "", "", "", false, google_protobuf_Timestamp_init_zero, {{NULL}, NULL}, 0, "", false, \
            com_daml_ledger_api_v2_TraceContext_init_zero, false,                             \
            google_protobuf_Timestamp_init_zero, false, {                                     \
            0, {                                                                              \
                0                                                                             \
            }                                                                                 \
        }                                                                                     \
...
#define com_daml_ledger_api_v2_TreeEvent_kind_exercised_MSGTYPE \
...
#define com_daml_ledger_api_v2_TransactionTree_events_by_id_MSGTYPE \
    com_daml_ledger_api_v2_TransactionTree_EventsByIdEntry
#define com_daml_ledger_api_v2_TransactionTree_trace_context_MSGTYPE \
...
#define com_daml_ledger_api_v2_TransactionTree_EventsByIdEntry_value_MSGTYPE \
    com_daml_ledger_api_v2_TreeEvent
...
#define com_daml_ledger_api_v2_TransactionTree_EventsByIdEntry_fields \
    &com_daml_ledger_api_v2_TransactionTree_EventsByIdEntry_msg
...
#if defined(com_daml_ledger_api_v2_CreatedEvent_size) && \
    defined(com_daml_ledger_api_v2_ExercisedEvent_size)
#define com_daml_ledger_api_v2_TransactionTree_EventsByIdEntry_size \
    (17 + sizeof(union com_daml_ledger_api_v2_TreeEvent_kind_size_union))
#define com_daml_ledger_api_v2_TreeEvent_size \
    (0 + sizeof(union com_daml_ledger_api_v2_TreeEvent_kind_size_union))
union com_daml_ledger_api_v2_TreeEvent_kind_size_union {
    char f1[(6 + com_daml_ledger_api_v2_CreatedEvent_size)];
    char f2[(6 + com_daml_ledger_api_v2_ExercisedEvent_size)];
};
#endif
