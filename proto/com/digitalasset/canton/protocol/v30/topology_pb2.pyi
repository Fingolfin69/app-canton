...
class DecentralizedNamespaceDefinition(_message.Message):
    __slots__ = ["decentralized_namespace", "owners", "threshold"]
...
class DynamicSequencingParametersState(_message.Message):
    __slots__ = ["sequencing_parameters", "synchronizer_id"]
...
class MediatorSynchronizerState(_message.Message):
    __slots__ = ["active", "group", "observers", "synchronizer_id", "threshold"]
...
class MultiTransactionSignatures(_message.Message):
    __slots__ = ["signatures", "transaction_hashes"]
...
class NamespaceDelegation(_message.Message):
    __slots__ = ["can_sign_all_but_namespace_delegations", "can_sign_all_mappings", "can_sign_specific_mapings", "is_root_delegation", "namespace", "target_key"]
...
class ParticipantSynchronizerPermission(_message.Message):
    __slots__ = ["limits", "login_after", "participant_uid", "permission", "synchronizer_id"]
...
class PartyHostingLimits(_message.Message):
    __slots__ = ["party", "synchronizer_id"]
...
class PartyToKeyMapping(_message.Message):
    __slots__ = ["party", "signing_keys", "threshold"]
    PARTY_FIELD_NUMBER: _ClassVar[int]
...
class PartyToParticipant(_message.Message):
    __slots__ = ["participants", "party", "threshold"]
    class HostingParticipant(_message.Message):
        __slots__ = ["onboarding", "participant_uid", "permission"]
...
class PurgeTopologyTransaction(_message.Message):
    __slots__ = ["mappings", "synchronizer_id"]
    MAPPINGS_FIELD_NUMBER: _ClassVar[int]
    SYNCHRONIZER_ID_FIELD_NUMBER: _ClassVar[int]
...
class SequencerConnectionSuccessor(_message.Message):
    __slots__ = ["connection", "sequencer_id", "synchronizer_id"]
    class SequencerConnection(_message.Message):
        __slots__ = ["grpc"]
        class Grpc(_message.Message):
            __slots__ = ["custom_trust_certificates", "endpoints"]
...
class SequencerSynchronizerState(_message.Message):
    __slots__ = ["active", "observers", "synchronizer_id", "threshold"]
    ACTIVE_FIELD_NUMBER: _ClassVar[int]
    OBSERVERS_FIELD_NUMBER: _ClassVar[int]
    SYNCHRONIZER_ID_FIELD_NUMBER: _ClassVar[int]
    THRESHOLD_FIELD_NUMBER: _ClassVar[int]
...
class SignedTopologyTransaction(_message.Message):
    __slots__ = ["multi_transaction_signatures", "proposal", "signatures", "transaction"]
...
class TopologyMapping(_message.Message):
    __slots__ = ["decentralized_namespace_definition", "mediator_synchronizer_state", "namespace_delegation", "owner_to_key_mapping", "participant_permission", "party_hosting_limits", "party_to_key_mapping", "party_to_participant", "purge_topology_txs", "sequencer_connection_successor", "sequencer_synchronizer_state", "sequencing_dynamic_parameters_state", "synchronizer_parameters_state", "synchronizer_trust_certificate", "synchronizer_upgrade_announcement", "vetted_packages"]
...
class TopologyTransaction(_message.Message):
    __slots__ = ["mapping", "operation", "serial"]
...
class VettedPackages(_message.Message):
    __slots__ = ["package_ids", "packages", "participant_uid"]
