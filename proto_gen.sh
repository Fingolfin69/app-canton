...
com.daml.ledger.api.v2.Value.numeric type:FT_POINTER max_size:64
com.daml.ledger.api.v2.Value.party type:FT_POINTER max_size:256
com.daml.ledger.api.v2.Value.text type:FT_POINTER max_size:1024
com.daml.ledger.api.v2.Value.contract_id type:FT_POINTER max_size:256
com.daml.ledger.api.v2.Identifier.package_id type:FT_POINTER max_size:256
com.daml.ledger.api.v2.Identifier.module_name type:FT_POINTER max_size:256
com.daml.ledger.api.v2.Identifier.entity_name type:FT_POINTER max_size:256
com.daml.ledger.api.v2.Variant.constructor type:FT_POINTER max_size:128
com.daml.ledger.api.v2.Enum.constructor type:FT_POINTER max_size:128
com.daml.ledger.api.v2.RecordField.label type:FT_POINTER max_size:128
com.daml.ledger.api.v2.TextMap.Entry.key type:FT_POINTER max_size:256
com.daml.ledger.api.v2.Record.fields type:FT_POINTER
EOF
# com.daml.ledger.api.v2.TextMap.entries type:FT_POINTER max_count:16
...
com.daml.ledger.api.v2.interactive.transaction.v1.Create.lf_version type:FT_POINTER max_size: 8
com.daml.ledger.api.v2.interactive.transaction.v1.Create.contract_id type:FT_POINTER max_size: 128
com.daml.ledger.api.v2.interactive.transaction.v1.Create.package_name type:FT_POINTER max_size: 128
com.daml.ledger.api.v2.interactive.transaction.v1.Create.signatories type:FT_POINTER max_size: 128 max_count: 2
com.daml.ledger.api.v2.interactive.transaction.v1.Create.stakeholders type:FT_POINTER max_size: 128 max_count: 2
com.daml.ledger.api.v2.interactive.transaction.v1.Exercise.signatories type:FT_POINTER max_size: 128 max_count: 10
com.daml.ledger.api.v2.interactive.transaction.v1.Exercise.stakeholders type:FT_POINTER max_size: 128 max_count: 10
com.daml.ledger.api.v2.interactive.transaction.v1.Exercise.acting_parties type:FT_POINTER max_size: 128 max_count: 10
com.daml.ledger.api.v2.interactive.transaction.v1.Exercise.choice_observers type:FT_POINTER max_size: 128 max_count: 10
com.daml.ledger.api.v2.interactive.transaction.v1.Fetch.signatories type:FT_POINTER max_size: 128 max_count: 10
com.daml.ledger.api.v2.interactive.transaction.v1.Fetch.stakeholders type:FT_POINTER max_size: 128 max_count: 10
com.daml.ledger.api.v2.interactive.transaction.v1.Fetch.acting_parties type:FT_POINTER max_size: 128 max_count: 10
com.daml.ledger.api.v2.interactive.transaction.v1.Fetch.interface_id type:FT_POINTER max_size: 256
com.daml.ledger.api.v2.interactive.transaction.v1.Exercise.interface_id type:FT_POINTER max_size: 256
EOF
...
* anonymous_oneof:true
# PREPAREDTX
# Limit the number of roots and nodes in the DamlTransaction
com.daml.ledger.api.v2.interactive.DamlTransaction.version type:FT_POINTER max_size: 8
com.daml.ledger.api.v2.interactive.DamlTransaction.roots type:FT_POINTER max_size: 8 max_count: 1
com.daml.ledger.api.v2.interactive.DamlTransaction.roots type:FT_POINTER max_count: 1
com.daml.ledger.api.v2.interactive.DamlTransaction.nodes type:FT_POINTER max_count: 10000
com.daml.ledger.api.v2.interactive.DamlTransaction.node_seeds type:FT_POINTER max_count: 1 
com.daml.ledger.api.v2.interactive.DamlTransaction.Node.node_id type:FT_POINTER max_size: 8
com.daml.ledger.api.v2.interactive.DamlTransaction.NodeSeed type:FT_POINTER max_size: 64
# METADATA
com.daml.ledger.api.v2.interactive.ExecuteSubmissionRequest.submission_id type:FT_POINTER max_size: 128
com.daml.ledger.api.v2.interactive.ExecuteSubmissionRequest.user_id type:FT_POINTER max_size: 128
com.daml.ledger.api.v2.interactive.Metadata.synchronizer_id type:FT_POINTER max_size: 128
com.daml.ledger.api.v2.interactive.Metadata.transaction_uuid type:FT_POINTER max_size: 64
com.daml.ledger.api.v2.interactive.Metadata.input_contracts type:FT_POINTER max_size: 64
com.daml.ledger.api.v2.interactive.Metadata.SubmitterInfo.act_as type:FT_POINTER max_size: 128 max_count: 1
com.daml.ledger.api.v2.interactive.Metadata.SubmitterInfo.command_id type:FT_POINTER max_size: 64
# FIXME: SKIPPED ATM
#com.daml.ledger.api.v2.interactive.Metadata.input_contracts max_count: 1
EOF
