...
typedef struct _com_daml_ledger_api_v2_interactive_MinLedgerTime {
    ...
    union _com_daml_ledger_api_v2_interactive_MinLedgerTime_time {
...
typedef struct _com_daml_ledger_api_v2_interactive_Metadata_InputContract {
    ...
    union _com_daml_ledger_api_v2_interactive_Metadata_InputContract_contract {
...
typedef struct _com_daml_ledger_api_v2_interactive_ExecuteSubmissionRequest {
 ...
 Note that currently, only single party submissions are supported. */
    ...
    union _com_daml_ledger_api_v2_interactive_ExecuteSubmissionRequest_deduplication_period {
 ...
 should be scheduled to executed within the window allowed by synchronizer. */
    bool has_min_ledger_time;
    com_daml_ledger_api_v2_interactive_MinLedgerTime min_ledger_time; /* Optional */
...
typedef struct _com_daml_ledger_api_v2_interactive_DamlTransaction_Node {
    ...
    union _com_daml_ledger_api_v2_interactive_DamlTransaction_Node_versioned_node {
